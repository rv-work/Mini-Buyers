...
export const csvRowSchema = z.object({
  ...
  email: z.string().email().optional().or(z.literal("")),
  phone: z.string().regex(/^\d{10,15}$/),
  city: z.string().refine((val) => Object.values(City).includes(val as City)),
  propertyType: z
    .string()
    .refine((val) => Object.values(PropertyType).includes(val as PropertyType)),
  bhk: z.string().optional(),
  purpose: z
    .string()
    .refine((val) => Object.values(Purpose).includes(val as Purpose)),
  budgetMin: z
    .string()
    .optional()
  ...
  timeline: z
    .string()
    .refine((val) => Object.values(Timeline).includes(val as Timeline)),
  source: z
    .string()
    .refine((val) => Object.values(Source).includes(val as Source)),
  notes: z.string().max(1000).optional(),
  tags: z
    .string()
    .optional()
